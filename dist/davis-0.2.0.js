// davis.js JavaScript Routing, version: 0.2.0
...
Davis.router = function () {
   ...
   * @param {Function} handler The handler for this route, will be called with the request that triggered
   * the route
   *
   * ### Example
   *
 ...
 *
 * @returns {String} string The location that the url bar should display and should be pushed onto the
 * history stack for this request.
 */
