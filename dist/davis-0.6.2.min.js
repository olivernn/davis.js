...
Davis.utils=function(){return{every:Array.prototype.every?function(a,b,c){return a.every(b,c)}:function(a,b,c){if(a===void 0||a===null)throw new TypeError;var a=Object(a),e=a.length>>>0;if(typeof b!=="function")throw new TypeError;for(var d=0;d<e;d++)if(d in a&&!b.call(c,a[d],d,a))return!1;return!0},forEach:Array.prototype.forEach?function(a,b,c){return a.forEach(b,c)}:function(a,b,c){if(a===void 0||a===null)throw new TypeError;var a=Object(a),e=a.length>>>0;if(typeof b!=="function")throw new TypeError;
for(var d=0;d<e;d++)d in a&&b.call(c,a[d],d,a)},filter:Array.prototype.filter?function(a,b,c){return a.filter(b,c)}:function(a,b,c){if(a===void 0||a===null)throw new TypeError;var a=Object(a),e=a.length>>>0;if(typeof b!=="function")throw new TypeError;for(var d=[],f=0;f<e;f++)if(f in a){var g=a[f];b.call(c,g,f,a)&&d.push(g)}return d},map:Array.prototype.map?function(a,b,c){return a.map(b,c)}:function(a,b,c){if(a===void 0||a===null)throw new TypeError;var a=Object(a),e=a.length>>>0;if(typeof b!=="function")throw new TypeError;
...
Davis.listener=function(){var a={A:function(a){return a.host!==window.location.host},FORM:function(a){var c=document.createElement("a");c.href=a.action;return this.A(c)}},b=function(c){return function(){if(!a[this.nodeName.toUpperCase()]||a[this.nodeName.toUpperCase()](this))return!0;var b=new Davis.Request(c.call(jQuery(this)));Davis.location.assign(b);return!1}},c=b(function(){var a=this;return{method:"get",fullPath:this.attr("href"),title:this.attr("title"),delegateToServer:function(){window.location.pathname=
a.attr("href")}}}),e=b(function(){var a=this;return{method:this.attr("method"),fullPath:decodeURI(this.serialize()?[this.attr("action"),this.serialize()].join("?"):this.attr("action")),title:this.attr("title"),delegateToServer:function(){a.submit()}}});return{listen:function(){jQuery(document).delegate(this.settings.formSelector,"submit",e);jQuery(document).delegate(this.settings.linkSelector,"click",c)},unlisten:function(){jQuery(document).undelegate(this.settings.linkSelector,"click",c);jQuery(document).undelegate(this.settings.formSelector,
"submit",e)}}}();Davis.event={_callbacks:{},bind:function(a,b){this._callbacks[a]||(this._callbacks[a]=[]);this._callbacks[a].push(b);return this},trigger:function(a){var b=this,c=arguments;this._callbacks[a]||(this._callbacks[a]=[]);Davis.utils.forEach(this._callbacks[a],function(a){a.apply(b,Davis.utils.toArray(c,1))});return this}};
...
Davis.history=function(){var a=[],b=!0,c=function(a){return function(c){c.state&&c.state._davis?a(new Davis.Request(c.state._davis)):b||a(Davis.Request.forPageLoad());b=!1}},e=function(a){return{_davis:a}};return{onChange:function(b){a.push(b);b=c(b);window.addEventListener("popstate",b,!0)},current:function(){return window.location.pathname+(window.location.search?window.location.search:"")},assign:function(c){history.pushState(e(c.asJSON()),c.title,c.location());Davis.utils.forEach(a,function(a){a(c)})},
replace:function(c){history.replaceState(e(c.asJSON()),c.title,c.location());Davis.utils.forEach(a,function(a){a(c)})}}}();Davis.location=function(){var a=Davis.history;return{setLocationDelegate:function(b){a=b},current:function(){return a.current()},assign:function(b){a.assign(b)},replace:function(b){a.replace(b)},onChange:function(b){a.onChange(b)}}}();
Davis.Request=function(a){var a=jQuery.extend({},{title:"",fullPath:"",method:"get"},a),b=this;this.raw=a;this.params={};this.title=a.title;this.queryString=a.fullPath.split("?")[1];this._staleCallback=function(){};this.queryString&&Davis.utils.forEach(this.queryString.split("&"),function(a){var e=a.split("=")[0],a=a.split("=")[1],d;if(d=/^(\w+)\[(\w+)\](\[\])?/.exec(e)){var f=d[1],e=d[2],g=b.params[f]||{};d[3]?(g[e]=g[e]||[],g[e].push(a)):g[e]=a;b.params[f]=g}else b.params[e]=a});a.fullPath=a.fullPath.replace(/^https?:\/\/.+?\//,
"/");this.method=(this.params._method||a.method).toLowerCase();this.path=a.fullPath.replace(/\?.+$/,"").replace(/^https?:\/\/[^\/]+/,"");this.fullPath=a.fullPath;this.delegateToServer=a.delegateToServer||Davis.noop;this.isForPageLoad=a.forPageLoad||!1;Davis.Request.prev&&Davis.Request.prev.makeStale(this);Davis.Request.prev=this};Davis.Request.prototype.redirect=function(a){Davis.location.replace(new Davis.Request({method:"get",fullPath:a,title:this.title}))};
Davis.Request.prototype.whenStale=function(a){this._staleCallback=a};Davis.Request.prototype.makeStale=function(a){this._staleCallback.call(a,a)};Davis.Request.prototype.location=function(){return this.method==="get"?this.fullPath:""};Davis.Request.prototype.toString=function(){return[this.method.toUpperCase(),this.fullPath].join(" ")};Davis.Request.prototype.asJSON=function(){return{title:this.raw.title,fullPath:this.raw.fullPath,method:this.raw.method}};
