...
Davis.listener=function(){var a={A:function(a){return a.host!==window.location.host},FORM:function(a){var c=document.createElement("a");c.href=a.action;return this.A(c)}},b=function(c){return function(){var b;b=a[this.nodeName.toUpperCase()]?a[this.nodeName.toUpperCase()](this):!0;if(b)return!0;b=new Davis.Request(c.call(jQuery(this)));Davis.location.assign(b);return!1}},c=b(function(){var a=this;return{method:"get",fullPath:this.attr("href"),title:this.attr("title"),delegateToServer:function(){window.location.pathname=
