...
"/");this.method=(this.params._method||a.method).toLowerCase();this.path=a.fullPath.replace(/\?.+$/,"").replace(/^https?:\/\/[^\/]+/,"");this.delegateToServer=a.delegateToServer||Davis.noop;this.isForPageLoad=a.forPageLoad||!1;Davis.Request.prev&&Davis.Request.prev.makeStale(this);Davis.Request.prev=this};Davis.Request.prototype.redirect=function(a){Davis.location.replace(new Davis.Request({method:"get",fullPath:a,title:this.title}))};
Davis.Request.prototype.whenStale=function(a){this._staleCallback=a};Davis.Request.prototype.makeStale=function(a){this._staleCallback.call(a,a)};Davis.Request.prototype.location=function(){return this.method==="get"?this.path+(this.queryString?"?"+this.queryString:""):""};Davis.Request.prototype.toString=function(){return[this.method.toUpperCase(),this.path].join(" ")};Davis.Request.prototype.asJSON=function(){return{title:this.raw.title,fullPath:this.raw.fullPath,method:this.raw.method}};
