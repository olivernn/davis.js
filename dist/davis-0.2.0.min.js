...
Davis.Request=function(c){var d=this;this.params={};this.title=c.title;this.queryString=c.fullPath.split("?")[1];this.type="request";this._staleCallback=function(){};this.queryString&&this.queryString.split("&").forEach(function(a){var b=a.split("=")[0];a=a.split("=")[1];var f;if(f=/^(\w+)\[(\w+)\]/.exec(b)){var e=f[1];b=f[2];f=d.params[e]||{};f[b]=a;d.params[e]=f}else d.params[b]=a});this.method=this.params._method||c.method;this.path=c.fullPath.replace(/\?.+$/,"");Davis.Request.prev&&Davis.Request.prev.makeStale();
Davis.Request.prev=this};Davis.Request.prototype.redirect=function(c){Davis.history.replaceState(new Davis.Request({method:"get",fullPath:c,title:this.title}))};Davis.Request.prototype.whenStale=function(c){this._staleCallback=c};Davis.Request.prototype.makeStale=function(){this._staleCallback()};Davis.Request.prototype.location=function(){return this.method==="state"?"":this.path};Davis.Request.prototype.toString=function(){return[this.method.toUpperCase(),this.path].join(" ")};
