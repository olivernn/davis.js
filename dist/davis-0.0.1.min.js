...
Davis.history=function(){var c=[],b=function(a){return function(d){d.state&&a(d.state)}};return{replaceState:function(a){history.replaceState(a,a.title,a.path);c.forEach(function(d){d(a)})},pushState:function(a){history.pushState(a,a.title,a.path);c.forEach(function(d){d(a)})},onChange:function(a){c.push(a);a=b(a);window.addEventListener("popstate",a)}}}();
Davis.Request=function(c){var b=this;this.method=c.method;this.params={};this.title=c.title;(this.queryString=c.fullPath.split("?")[1])&&this.queryString.split("&").forEach(function(a){b.params[a.split("=")[0]]=a.split("=")[1]});this.path=c.fullPath.replace(/\?.+$/,"")};Davis.Request.prototype={redirect:function(c){Davis.history.replaceState(new Davis.Request({method:"get",fullPath:c,title:this.title}))},toString:function(){return[this.method.toUpperCase(),this.path].join(" ")}};
