...
test("map iterating over an array", function () {
  var a = [1,2,3],
      b = [],
      count = 0
...
test("map iterating over an empty array", function () {
  var a = [],
      count = 0
...
test("map arguments passed to the function", function () {
  var a = ["foo"],
      b, element, index
...
test("map setting the context of the callback function", function () {
  var a = ["foo"],
      context = {},
      self
...
test("map returning a new array with the result of the function", function () {
  var a = [1,2,3],
      output
